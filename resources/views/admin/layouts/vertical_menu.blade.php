        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.products.index') }}">Все товары</a></li>
                        <li><a href="{{ route('admin.products.create') }}">Добавить</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.attributes.index') }}">Все характеристики</a></li>
                        <li><a href="{{ route('admin.attributes.create') }}">Добавить</a></li>
                    </ul>
                </li>
