            ...
            <div class="row h-100">
                <div class="col-lg-12">
                    <div class="breadcrumb-item">
                        <h1 class="breadcrumb-heading">О BeltStudio</h1>
                        {{ \Diglactic\Breadcrumbs\Breadcrumbs::view('components.breadcrumbs', 'about') }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="about-content">
                        ...
                        <div class="about-signature">
                            <img src="{{ asset('img/about/icon/2.png') }}" alt="Signature">
                        </div>
                    </div>
                </div>
            </div>
